...
public abstract class IHttpResponseCallBack<T> extends IHttpResponseBaseCallBack {
     ...
     */
    public abstract void onSuccess(T responseResult, Object originalObject);
     ...
     * @param originalObject
     */
    public abstract void onFail(int errorCode, String message, String result, Object originalObject);
}
